                      ...
                      <td className="px-6 py-5 text-center">
                        <div className="flex items-center justify-center gap-2">
                          ...
                          {['CANCELADA', 'Cancelada'].includes(apt.status) ? (
                            <button onClick={() => setConfirmModal({ isOpen: true, title: "Eliminar Cita", message: `¿Estás seguro de que deseas eliminar permanentemente la cita de ${apt.patient}? Esta acción no se puede deshacer.`, onConfirm: () => handleDelete(apt.id), isDanger: true })} title="Eliminar Permanentemente" className="p-2 rounded-lg text-slate-400 hover:text-rose-600 hover:bg-rose-50 transition"><svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg></button>
                          ) : (
